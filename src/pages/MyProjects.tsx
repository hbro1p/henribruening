  ...
  const projects: Project[] = [
    ...
    },
    {
      ...
      description: {
        ...
        de: '​Ich unterstütze den Immobilienmakler Kelwin Lamparter beim Aufbau seines Social-Media-Auftritts. Ich entwickle Content-Ideen, Hooks, Skripte und Reels rund um Immobilien, Verkauf und den Alltag als Makler. Des Weiteren sorge ich für ein getaktetes Social Media mit Integration von Datenbanken und Kundenautomationen und bin für die technische Umsetzbarkeit verantwortlich. Innerhalb von ca. zwei Monaten konnte der Account um etwa 1.400 Follower wachsen. Dabei ging es nicht nur um Reichweite, sondern auch darum, eine klare lokale Marke aufzubauen, Vertrauen zu schaffen und Inhalte zu produzieren, die zur Zielgruppe passen.',
    ...
    },
    {
      ...
      description: {
        ...
        de: '​In meiner Facharbeit „The Fading American Dream? Gentrification, Housing Affordability, and the Immigrant Experience in Brooklyn, New York“ habe ich untersucht, ob der American Dream in Brooklyn heute noch erreichbar ist.\n\nAm Anfang habe ich versucht, über normale E-Mails Kontakt zu Maklern und Aktivisten aufzunehmen. Das hat kaum funktioniert. Deshalb habe ich einen Reddit-Post erstellt, der über 17.000 Aufrufe erreicht hat. Dadurch kam ich direkt mit Menschen aus Brooklyn in Kontakt und konnte fünf Video-Interviews führen.\n\nSo konnte ich persönliche Erfahrungen von Locals mit Daten, Statistiken und wissenschaftlichen Quellen verbinden. Mein Ergebnis war, dass der klassische American Dream, vor allem das eigene Haus, für viele Menschen in Brooklyn kaum noch erreichbar ist. Gleichzeitig hat sich die Bedeutung verändert: Heute steht der American Dream für viele eher für Zugehörigkeit, Freiheit und persönliche Erfüllung.\n\nFür die Facharbeit habe ich 14 Punkte bekommen. Wichtiger als die Note war für mich aber die Erfahrung, nicht nur lange zu überlegen, sondern einfach loszulegen, Menschen direkt anzusprechen und eigene Wege zu finden, wenn der normale Weg nicht funktioniert.',
