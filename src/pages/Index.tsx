  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-200 via-blue-300 to-blue-400 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-20 left-20 w-3 h-3 bg-yellow-500 animate-bounce delay-100"></div>
        <div className="absolute top-40 right-32 w-2 h-2 bg-yellow-600 animate-bounce delay-300"></div>
        <div className="absolute bottom-32 left-40 w-3 h-3 bg-yellow-500 animate-bounce delay-500"></div>
        <div className="absolute bottom-20 right-20 w-2 h-2 bg-yellow-600 animate-bounce delay-700"></div>
      </div>
