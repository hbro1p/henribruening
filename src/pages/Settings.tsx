        ...
        <div className={`p-3 rounded-t border-b-4 shadow-inner relative ${
          ...
          <div className="flex items-center space-x-3 relative z-10">
            ...
            <span className={`font-pixel text-lg ml-3 drop-shadow-lg ${
              theme === 'dark-vhs' ? 'text-white' : 'text-white'
            }`}>{t('Settings')}</span>
          </div>
        </div>
          ...
          <div className="relative z-10 space-y-8">
            ...
            <div className={`p-6 rounded-lg border-3 shadow-xl ${
              ...
              <h2 className={`text-2xl font-pixel mb-6 drop-shadow-sm relative z-10 ${
                theme === 'dark-vhs' ? 'text-white' : 'text-black'
              }`}>{t('Language')}</h2>
                ...
                {themes.map((themeOption) => (
                  ...
                  >
                    <div className={`w-full h-12 rounded-md mb-3 border-2 shadow-inner ${
                      theme === 'dark-vhs' ? 'border-white/30' : 'border-black/30'
                    } ${themeOption.preview}`}>
            ...
            <div className="flex justify-center">
              <Link 
                to="/desktop" 
                className={`inline-flex items-center gap-3 px-6 py-3 rounded-lg border-3 transition-all duration-200 hover:scale-105 transform-gpu font-pixel text-xl shadow-lg ${
                  theme === 'dark-vhs'
                    ? 'bg-gradient-to-br from-gray-700/80 via-black/90 to-gray-800/80 border-white/40 text-white hover:border-white/60 hover:from-gray-600/80'
                    : 'bg-gradient-to-br from-blue-500 via-blue-600 to-blue-700 border-blue-800/40 text-white hover:border-blue-700/60 hover:from-blue-400'
                }`}
              >
