        ...
        <div className={`transition-all duration-1000 z-10 max-w-6xl mx-auto ${showContent ? 'opacity-100 scale-100' : 'opacity-0 scale-95'}`}>
          ...
          <div className="mt-24 animate-fade-in flex justify-center" style={{ animationDelay: '0.6s', animationFillMode: 'both' }}>
            <button
              ...
              className="w-20 h-20 rounded-full overflow-hidden border-2 border-white/50 shadow-lg hover:scale-110 transition-transform duration-300 cursor-pointer relative"
            >
              <img 
                src={henriProfile} 
                alt="Henri" 
              ...
              />
              {/* Notification Badge */}
              <div className="absolute top-0 right-0 w-5 h-5 bg-red-500 border-2 border-white rounded-full animate-pulse shadow-lg"></div>
            </button>
          </div>
