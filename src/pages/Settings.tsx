  ...
  const themes = [
    {
      id: 'dreamos' as const,
      name: t('DreamOS'),
      preview: 'bg-gradient-to-br from-pink-500 via-purple-500 to-cyan-400'
    },
    {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen p-4 sm:p-8">
      ...
      <div className={`p-3 border-4 w-full max-w-2xl shadow-2xl rounded-lg ${
        theme === 'dark-vhs' 
          ? 'bg-gradient-to-br from-green-900/20 via-black/90 to-purple-900/20 border-green-500/50' 
        ...
        <div className={`p-3 rounded-t border-b-4 shadow-inner relative ${
          theme === 'dark-vhs'
            ? 'bg-gradient-to-r from-green-800/80 via-black/90 to-purple-800/80 border-green-500/30'
          ...
          <div className="flex items-center space-x-3 relative z-10">
            <div className={`w-4 h-4 rounded-full border-2 shadow-lg ${
              theme === 'dark-vhs'
                ? 'bg-gradient-to-br from-red-400 via-red-500 to-red-700 border-green-500/30'
            ...
            <div className={`w-4 h-4 rounded-full border-2 shadow-lg ${
              theme === 'dark-vhs'
                ? 'bg-gradient-to-br from-yellow-400 via-yellow-500 to-yellow-700 border-green-500/30'
            ...
            <span className={`font-pixel text-lg ml-3 drop-shadow-lg ${
              theme === 'dark-vhs' ? 'text-green-400' : 'text-white'
            }`}>{t('Settings')}</span>
          </div>
        </div>
        ...
        <div className={`p-8 border-4 shadow-inner rounded-b relative ${
          theme === 'dark-vhs'
            ? 'bg-gradient-to-br from-black/95 via-green-900/10 to-purple-900/10 border-green-500/30'
          ...
          <div className="relative z-10 space-y-8">
            ...
            <div className={`p-6 rounded-lg border-3 shadow-xl ${
              theme === 'dark-vhs'
                ? 'bg-gradient-to-br from-black/80 via-green-900/20 to-purple-900/20 border-green-500/40'
              ...
              <h2 className={`text-2xl font-pixel mb-6 drop-shadow-sm relative z-10 ${
                theme === 'dark-vhs' ? 'text-green-400' : 'text-black'
              }`}>{t('Language')}</h2>
                ...
                {themes.map((themeOption) => (
                  ...
                  >
                    <div className={`w-full h-12 rounded-md mb-3 border-2 shadow-inner ${
                      theme === 'dark-vhs' ? 'border-green-500/30' : 'border-black/30'
                    } ${themeOption.preview}`}>
            ...
            <div className={`p-6 rounded-lg border-3 shadow-xl ${
              theme === 'dark-vhs'
                ? 'bg-gradient-to-br from-black/90 via-green-900/30 to-purple-900/30 border-green-500/50'
