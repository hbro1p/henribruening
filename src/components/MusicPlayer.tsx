...
const MusicPlayer = () => {
  ...
  return (
    <>
      ...
      <div className="fixed bottom-8 right-8 bg-windows-gray p-2 border-t-2 border-l-2 border-white border-b-2 border-r-2 border-black w-80 shadow-2xl font-pixel">
