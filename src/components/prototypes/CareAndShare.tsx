          ...
          <div className="bg-white rounded-2xl shadow-xl p-6 m-4 min-h-screen">
            ...
            <div className="space-y-6">
              ...
              <button
                ...
                className="w-full bg-blue-600 text-white py-4 px-6 rounded-2xl font-semibold text-lg hover:bg-blue-700 transition-colors mb-80"
              >
          ...
          <div className="bg-white rounded-2xl shadow-xl p-6 m-4 min-h-screen">
            ...
            <div className="space-y-6">
              ...
              <button
                ...
                className="w-full bg-green-600 text-white py-4 px-6 rounded-2xl font-semibold text-lg hover:bg-green-700 transition-colors mb-80"
              >
          ...
          <div className="bg-white rounded-2xl shadow-xl p-6 m-4 min-h-screen">
            <div className="text-center">
              ...
              <button
                ...
                className="w-full bg-blue-600 text-white py-3 px-6 rounded-xl font-semibold hover:bg-blue-700 transition-colors mb-80"
              >
