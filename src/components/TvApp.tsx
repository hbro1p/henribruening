  ...
  if (!isAuthenticated) {
    return (
      <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4">
        <div className="bg-gradient-to-br from-gray-900 via-gray-800 to-black border-2 border-red-500 rounded-lg p-8 w-96 max-w-full shadow-lg shadow-red-500/20">
          <button
            onClick={onClose}
          ...
          <div className="text-center mb-6">
            <div className="w-16 h-16 mx-auto mb-4 bg-gray-800 rounded-lg flex items-center justify-center border-2 border-red-500">
    ...
    <div className="fixed inset-0 bg-black flex items-center justify-center z-50 p-4">
      <div className="relative w-full max-w-4xl h-full max-h-[80vh] bg-gradient-to-br from-gray-900 via-gray-800 to-black border-4 border-gray-600 rounded-lg overflow-hidden shadow-2xl">
        ...
        <div className="relative z-20 p-4 bg-gradient-to-r from-gray-800 to-gray-700 border-b-2 border-gray-600">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              <div className="w-12 h-12 bg-gray-900 rounded border-2 border-gray-500 flex items-center justify-center">
        ...
        <div className="relative flex-1 bg-black p-4" style={{ height: 'calc(100% - 140px)' }}>
          {videos.length > 0 ? (
            <div className="relative w-full h-full bg-black rounded border border-gray-700">
              {/* Scanlines effect */}
              <div 
              ...
              {/* Video overlay info */}
              <div className="absolute bottom-4 left-4 bg-black/70 rounded px-3 py-1 border border-green-500/30">
            ...
            <div className="w-full h-full bg-black rounded border border-gray-700 flex items-center justify-center">
              <div className="text-center">
                <div className="text-6xl mb-4">📡</div>
                <p className="text-green-400 font-mono text-lg">NO SIGNAL</p>
        ...
        <div className="relative z-20 p-4 bg-gradient-to-r from-gray-800 to-gray-700 border-t-2 border-gray-600">
          <div className="flex items-center justify-center space-x-4">
            <button
              ...
              className="w-12 h-12 rounded bg-gray-700 hover:bg-gray-600 text-green-400 border border-green-500/50 flex items-center justify-center transition-all disabled:opacity-50"
            >
            ...
            <button
              ...
              disabled={videos.length === 0}
              className="w-16 h-12 rounded bg-green-900 hover:bg-green-800 text-green-300 border border-green-500 flex items-center justify-center transition-all disabled:opacity-50"
            >
              {isPlaying ? 
